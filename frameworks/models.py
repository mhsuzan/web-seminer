...
class Framework(models.Model):
    ...
    description = models.TextField(blank=True, help_text="Abstract/Description of the framework")
    objectives = models.TextField(blank=True, help_text="Objectives of the framework")
    methodology = models.TextField(blank=True, help_text="Methodology used in the framework")
    algorithm_used = models.CharField(max_length=500, blank=True, help_text="Algorithm or technique used")
    top_model = models.CharField(max_length=200, blank=True, help_text="Top model or main contribution")
    accuracy = models.CharField(max_length=200, blank=True, help_text="Accuracy or performance metrics")
    advantages = models.TextField(blank=True, help_text="Advantages of the framework")
    drawbacks = models.TextField(blank=True, help_text="Drawbacks or limitations")
